 ...
 */
@Component({
  selector: 'app-auditors-field',
  templateUrl: './auditors-field.component.html',
  styleUrls: ['./auditors-field.component.scss']
})
export class AuditorsFieldComponent extends TenantComponent implements OnInit {
  ...
  componentId = '9aaf6c63-b04b-4258-ap8b-659c48c4a000';
  ...
  async ngOnInit(): Promise<void> {
    const data = await this.usersService.getAuditorCompanies(this.tenant);
