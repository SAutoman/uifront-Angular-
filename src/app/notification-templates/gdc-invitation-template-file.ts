export const GDCInvitationsTemplate = `@model WFM.Services.Services.InvitationModel
                                                ...
                                                <th class="small-12 large-12 columns first last">
                                                    <table>
                                                        <tbody>
                                                            <tr>
                                                                <th>
                                                                    <p class="lead" style="text-align: left;">尊敬的先生/女士,</p>
                                                                    <table class="spacer"><tbody><tr><td height="16" style="font-size:16px;line-height:16px;">&nbsp;</td></tr></tbody></table>
                                                                    <p style="line-height: 1.5; text-align: left;">
                                                                        我们邀请您加入Gries Deco公司的EUTR在线系统（Cargoclix工作流程管理）。
                                                                    </p>
																	<p style="text-align: left;">
																	在该系统中，您将能够上传所有EUTR的相关文件，以遵守《欧洲木材法规》。
																	</p>

                                                                    <table class="spacer"><tbody><tr><td height="16" style="font-size:16px;line-height:16px;">&nbsp;</td></tr></tbody></table>

                                                                    <p style="line-height: 1.5; text-align: left;" >																		
																		请点击 <a href="@Model.Link">here</a> 进行注册。如果无法转到页面，请在浏览器中复制并粘贴以下链接： @Model.Link .
                                                                    </p>
																	...
																	<p style="text-align: left;">如果您没有收到EUTR指南，请联系EUTR@g-d-c.eu。</p>
                                                                    <p style="text-align: left;">感谢您，并致以亲切的问候<</p>
                                                                    <p class="lead" style="text-align: left;">GDC的EUTR团队“</p>
