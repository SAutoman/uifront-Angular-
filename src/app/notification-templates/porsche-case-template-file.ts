export const PorscheCasesTemplate = `@model WFM.ConfigurationsAndModels.DTOs.DynamicEntities.DynamicEntityDto
            ...
            <td class="center" align="center" valign="top">
                <center>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <th>
                                                                    ...
                                                                    var datumUndAnmeldungUhrzeit = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("datumUndAnmeldungUhrzeit")?.ToText();
                                                                    var relation = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("relation")?.ToText();
                                                                    var kundenNummer = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("kundenNummer")?.ToText();
                                                                    var containerNummer = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("containerNummer")?.ToText();
                                                                    var rampe = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("rampe")?.ToText();
                                                                    var taraGewicht = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("taraGewicht")?.ToText();
                                                                    var transportbeleg = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("transportbeleg")?.ToText();
                                                                    var siegelNo = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("siegelNo")?.ToText();
                                                                    var imo = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("imo")?.ToText();
                                                                    var cont = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("cont")?.ToText();
                                                                    var type = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("type")?.ToText();
                                                                    var niO = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("niO")?.ToText();
                                                                    var abzugsterminIst = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("abzugsterminIst")?.ToText();
                                                                    var abzugsterminSoll = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("abzugsterminSoll")?.ToText();
                                                                    var dlReferenz = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("dlReferenz")?.ToText();
                                                                    var schiff = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("schiff")?.ToText();
                                                                    var ets = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("ets")?.ToText();
                                                                    var eta = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("eta")?.ToText();
                                                                    var empfangshafen = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("empfangshafen")?.ToText();
                                                                    var anlieferreferenzSeehafen = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("anlieferreferenzSeehafen")?.ToText();
                                                                    var anlieferterminalSeehafen = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("anlieferterminalSeehafen")?.ToText();
                                                                    var cargoClosingSeehafen = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("cargoClosingSeehafen")?.ToText();
                                                                    var bemerkungen = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("bemerkungen")?.ToText();
                                                                    var yardIn = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("yardIn")?.ToText();
                                                                    var yardOutAnRampe = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("yardOutAnRampe")?.ToText();
                                                                    var yardInVonRampe = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("yardInVonRampe")?.ToText();
                                                                    var outFinal = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("outFinal")?.ToText();
                                                                    var bemerkung = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("bemerkung")?.ToText();
                                                                    var abweichungInH = ((WFM.ConfigurationsAndModels.DTOs.DynamicEntities.BaseDynamicEntityDto)item).GetField("abweichungInH")?.ToText();
                    ...
                    @if(rawDatas?.Value != null){
                     foreach(var item in rawDatas.Value)
                     {
                        var articleNumber =
