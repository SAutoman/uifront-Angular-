// // SAT: adapter for @angular-material-components/datetime-picker
// // source code copied from Angular Material material-luxon-adapter, added NgxMatDateAdapter specific methods
...
// import { DateTime as LuxonDateTime, Info as LuxonInfo, DateTimeOptions as LuxonDateTimeOptions } from 'luxon';
...
// export const NGX_MAT_LUXON_DATE_ADAPTER_OPTIONS = new InjectionToken<NgxMatLuxonDateAdapterOptions>('MAT_LUXON_DATE_ADAPTER_OPTIONS', {
//   providedIn: 'root',
//   factory: NGX_MAT_LUXON_DATE_ADAPTER_OPTIONS_FACTORY
// });

// export function NGX_MAT_LUXON_DATE_ADAPTER_OPTIONS_FACTORY(): NgxMatLuxonDateAdapterOptions {
//   return {
//     useUtc: false,
//     firstDayOfWeek: 0
//   };
...
// @Injectable()
// export class NgxMatLuxonDatetimeAdapter extends NgxMatDateAdapter<LuxonDateTime> {
...
//     const result = this._useUTC ? LuxonDateTime.utc(year, month + 1, date) : LuxonDateTime.local(year, month + 1, date);
...
//     }
//     return date.setLocale(this.locale).toFormat(displayFormat, <LocaleOptions>{ timeZone: this._useUTC ? 'utc' : undefined });
//   }
