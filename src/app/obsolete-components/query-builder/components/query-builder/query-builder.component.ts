...
//  * project
//  */
// import { CustomRule } from '../../../forms/models';
...
//   getForms() {
//     return this.config.forms.map((x) => {
//       const a = {};
//       a['name'] = x.name;
//       a['value'] = x.name;
//       return a;
...
//       parent.rules = parent.rules.concat(<any>[
//         {
//           field: field.value,
...
//   changeField(fieldValue: string, rule: CustomRule): void {
//     if (this.disabled) {
//       return;
//     }
//     const tempField = this.fields.find((x) => x.name === fieldValue);
//     rule.fieldRef = tempField.fieldRef;
...
//     };
//     if (defaultField) {
//       this.changeField(defaultField.value, <CustomRule>{
//         ...rule,
//         field: defaultField.value
//       });
//     } else {
